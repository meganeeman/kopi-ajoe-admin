-- approve_stock_request was referenced by the admin panel but was never created in this database.
...
begin
    ...
    -- Serializes cart_stocks updates for this cart/product pair, including the first insert.
